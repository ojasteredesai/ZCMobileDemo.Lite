    ...
    public class CheckBoxRenderer : ViewRenderer<CheckBox, Android.Widget.CheckBox>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<CheckBox> e)
        {
            ...
            if (this.Control == null)
            {
                ...
                //checkBox.SetBackgroundResource(ZCMobileDemo.Lite.Droid.Resource.Layout.RoundShap);
        ...
        private void CheckBoxCheckedChange(object sender, Android.Widget.CompoundButton.CheckedChangeEventArgs e)
        {
